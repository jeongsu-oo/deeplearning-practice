...
#      내 답:
# TODO
print(d.shape, d.isna().sum().sum(), d["EQP_CD"].value_counts())
"각각 279개"
"50:50"
...
# TODO
y = (d["EQP_CD"] == "P1-SP1-EXF01").astype(float).values
X = d[특징이름].values
...
w, b = 학습(z_tr, y_train)
dic = {}
for i, j in zip(특징이름, w):
    dic[i] = float(j)
print(sorted(dic,key=lambda t : ))
