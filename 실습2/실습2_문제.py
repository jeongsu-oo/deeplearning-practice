...
# TODO
print(d.shape, d.columns.to_list(), d.isna().sum().sum())
...
# TODO
print(d["CUR-MTR_RMS"].describe().round(2))
...
#             (2)
# TODO
print(d.corr(numeric_only=True)["CUR-MTR_RMS"].sort_values(ascending=False, key=abs))
"(1) CUR-MTR_STD, CUR-MTR_PTP"
"(2) 전류계 고장으로 추정하려는 거라서 동일한 전류계 값을 넣으면 안 된다."
